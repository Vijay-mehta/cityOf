                        ...
                        <li className="nav-item dropdown">
                            ...
                            <div className="dropdown-menu dropdown-menu-end user-dd animated flipInY">
                                <div className="d-flex no-block align-items-center p-3 bg-info text-white mb-2">
                                    ...
                                    <div className="ms-2">
                                        <h4 className="mb-0 text-white">CityofCares</h4>
                                        <p className=" mb-0">CityofCares@gmail.com</p>
                                    </div>
                                </div>
                                ...
                                <button type="button" className="btn d-block w-100 btn-info rounded-pill" onClick={() => {

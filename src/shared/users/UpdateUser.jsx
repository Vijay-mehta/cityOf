...
const Updateusers = (props) => {
    ...
    data.append(
      ...
      data.append(
        ...
        data.append(
          ...
          data.append(
            "State",State  === "" || null ? props.updatedData?.State  : State);
          data.append(
            "city", city === "" || null ? props.updatedData?.city  : city);
            data.append(
              "PinCode", PinCode === "" || null ? props.updatedData?.PinCode  : PinCode);
    data.append(
      "image",
  ...
  return (<>
    ...
    <div className="modal-body">
      ...
      <div className="row">
        <div className="col-md-12 mb-3">
          <label className="form-label">Edit Pin Code </label>
          <div className="position-relative">
            <input
              type="text"
